...
from model_stageA import Im2LatexTransformer
...
best_ckpt = ROOT / "stageA_best.pt"   # from early-stopping training
...
# model
model = Im2LatexTransformer(vocab_size=vocab_size, pad_idx=pad_idx).to(DEVICE)
